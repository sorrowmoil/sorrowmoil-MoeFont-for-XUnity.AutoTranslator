...
> ⚠️ Unity 5.x 2017 兼容性不做保证（详见[兼容性说明](#-兼容性说明)）
...
> <i>测试表明，开启了**Multi Atlas**后，游戏内会出现翻译丢失现象</i>
...
<details>
<summary><b>⚠️ 关于 Unity 5.x 2017 世代的特别说明</b></summary>

Unity 2017 世代字体资产基于 **2017.1.0b2** 构建，但由于目前未能找到可验证的 Unity 2017 游戏环境，**其兼容性不做保证**。  
Unity 5.x 世代字体资产基于 **5.2.0f** 构建，但由于目前未能找到可验证的 Unity 2017 游戏环境，**其兼容性不做保证**。
